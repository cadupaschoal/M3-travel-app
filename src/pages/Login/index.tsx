  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 h-screen w-full">
      ...
      <div className="bg-gray-800 flex flex-col justify-center">
        <form onSubmit={handleSubmit(submit)} className="max-w-[400px] w-full mx-auto bg-gray-900 p-8 px-8 rounded-lg">
          ...
          <button onClick={()=>{navigate("/register")}} className="w-full my-5 py-2 bg-red-500 text-white font-semibold rounded-lg">
            Cadastre-se
          </button>
        </form>
      </div>
